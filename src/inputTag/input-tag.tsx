...
import { IconClose } from '@eyas-design/icons';
...
function InputTag(baseProps: InputTagProps<string | ObjectValueType>, ref) {
  ...
  const props = useMergeProps<InputTagProps>(baseProps, defaultProps, {});
  const {
    className,
    style,
    placeholder,
  ...
  // https://github.com/eyas-design/eyas-design/issues/622
