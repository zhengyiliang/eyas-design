...
import { IconObliqueLine } from '@eyas-design/icons';
import omit from '../_util/omit';
import type { RouteProps, BreadcrumbProps } from './interface';
...
function Breadcrumb(baseProps: PropsWithChildren<BreadcrumbProps>, ref) {
  ...
  const props = useMergeProps<PropsWithChildren<BreadcrumbProps>>(baseProps, defaultProps, {});
